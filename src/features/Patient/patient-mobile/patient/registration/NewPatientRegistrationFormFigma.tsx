...
function InputField6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Input Field">
      <p className="font-['IBM_Plex_Sans_Thai:Medium',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#111928] text-[16px] w-full">อีเมล</p>
      <Input6 />
    </div>
  );
}
  ...
  return (
    <div className="relative size-full">
      <div className="flex flex-col items-center justify-start size-full">
        <div className="box-border content-stretch flex flex-col gap-[16px] items-start pb-[80px] pt-[12px] px-[20px] relative w-full">
          <InputField />
          <InputField1 />
          <InputField2 />
          <InputField3 />
...
export default function NewPatientRegistrationFormFigma() {
  return (
    <div className="bg-white relative rounded-tl-[24px] rounded-tr-[24px] size-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[12px] items-start relative size-full">
          <Frame1 />
        </div>
      </div>
    </div>
