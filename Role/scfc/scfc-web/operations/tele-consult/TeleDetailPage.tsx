        ...
        <div className="xl:col-span-2 space-y-6">
           ...
           <Card className="border-none shadow-sm rounded-2xl overflow-hidden bg-white">
              ...
              <CardContent className="p-8">
                <div className="h-[250px] w-full" style={{ width: '100%', minWidth: 0, minHeight: 250 }}>
                    ...
                    <div className="space-y-6">
                       ...
                       <div className="flex flex-col gap-2 items-end">
                          <div className="bg-teal-600 text-white p-4 rounded-2xl rounded-tr-none shadow-lg shadow-teal-600/10 text-sm font-medium leading-relaxed max-w-[90%]">
                             ...
                             รับทราบครับ ตรวจสอบความเสถียรแล้วพบความผิดปกติที่ต้นทาง กำลังรีเซ็ตลิงค์และเตรียมลิงค์สำรองให้ครับ
                          </div>
                       </div>
                    </div>
                 </ScrollArea>
