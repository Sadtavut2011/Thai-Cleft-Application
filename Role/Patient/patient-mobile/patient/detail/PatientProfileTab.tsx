                    ...
                    <div className="h-full">
                        <>
                            <div className="mb-6">
                                ...
                                {/* "แก้ไขแผนการรักษา" button — hidden in readOnly mode */}
                                {!readOnly && (
                                ...
                                {[...(patient.timeline || [])].sort((a: any, b: any) => parseAgeToMonths(b.age) - parseAgeToMonths(a.age)).map((item: any, index: number) => {
                                    ...
                                    return (
                                        <div key={index} className="relative pl-8 pb-8 last:pb-0">
                                            ...
                                            {/* Card — in readOnly mode, no click handler */}
                                            <div 
                                                className={cn(
                                                ...
                                                onClick={() => {
                                                    if (!readOnly) setSelectedMilestone(item);
                                                }}
                                            >
                    ...
                    <div className="animate-in fade-in duration-300 space-y-6">
                        <div className="p-6 bg-white border border-slate-100 rounded-2xl shadow-sm">
                            ...
                            <div className="mb-4">
                                ...
                                {/* "ขอการเบิกจ่ายทุน" button — hidden in readOnly mode */}
                                {!readOnly && (
                                    <div className="flex justify-end">
                            ...
                            <h5 className="font-bold text-slate-800 mb-3">ประวัติทุนสงเคราะห์</h5>
