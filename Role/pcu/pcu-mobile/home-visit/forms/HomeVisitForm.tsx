...
export function HomeVisitForm({ onBack, onSubmit, initialPatientId, isModal = false }: HomeVisitFormProps) {
  const [selectedPatientId, setSelectedPatientId] = useState<string>(initialPatientId || (MOCK_PATIENTS[0]?.id || ""));
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
          <CardContent className="p-4 md:p-6 space-y-6 flex-1">
            ...
            <div className="space-y-3">
              ...
              <Popover open={open} onOpenChange={setOpen}>
                <PopoverTrigger asChild>
                  ...
                  >
                    {selectedPatientId
                      ? MOCK_PATIENTS.find((p) => p.id === selectedPatientId)?.name + " (" + selectedPatientId + ")"
                      : "ค้นหาผู้ป่วย..."}
            ...
            <div className="space-y-3">
              ...
              <Select name="rph" defaultValue={selectedPatient?.rph || ""}>
