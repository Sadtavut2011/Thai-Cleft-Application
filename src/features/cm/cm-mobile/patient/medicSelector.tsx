...
const MOCK_OPTIONS = [
  "นพ. สมชาย ใจดี (ศัลยกรรม)",
  "พญ. สมหญิง รักษา (อายุรกรรม)",
  "นพ. เก่ง รักดี (กุมารเวช)",
  "พญ. ใจดี มากๆ (ทั่วไป)",
  "นพ. เชี่ยวชาญ พิเศษ (ศัลยกรรม)",
  "พญ. ดูแล ใส่ใจ (อายุรกรรม)"
];
      ...
      <div className="sticky top-0 z-[10000] w-full bg-[#7066a9] shadow-md flex flex-col">
        ...
        <div className="h-[64px] px-4 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-white text-lg font-bold">เลือกแพทย์</h1>
            </div>
        </div>
      </div>
