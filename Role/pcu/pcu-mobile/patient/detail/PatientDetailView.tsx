...
import { TreatmentDetail } from '../../../../cm/cm-mobile/patient/History/TreatmentDetail';
    ...
    if (isReferralOpen) {
        return (
            <ReferralRequestForm 
                ...
                role="PCU"
                onSubmit={(data) => {
                    console.log("Saving referral from Patient Detail:", data);
                    ...
                    toast.success("บันทึกการส่งตัวเรียบร้อยแล้ว");
                    
                    if (onAction) {
                        onAction('create-referral', data);
                    }
