...
export const PatientDetailView: React.FC<PatientDetailViewProps> = ({ patient: propPatient, onBack, onEdit, onAddMedicalRecord, onRequestFund, onAction, userRole = 'cm' }) => {
    ...
    const patient = {
        ...
        appointmentHistory: [
            ...
            { date: '20 ม.ค. 67', time: '08:30', title: 'ผ่าตัดเย็บซ��อมเพดานปาก', location: 'ห้องผ่าตัด รพ.มหาราช', status: 'completed', doctor: 'นพ.สมชาย ใจดี', note: '' },
            ...
            {isFundRequestOpen && (
                <FundRequestMobile
                    ...
                    onSubmit={() => {
                        ...
                        toast.success("สร้างคำขอทุนเรียบร้อยแล้ว");
                    }}
                />
            )}
        </div>
