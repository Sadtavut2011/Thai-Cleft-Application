               ...
               <div className="bg-white rounded-xl p-6 shadow-sm flex flex-col items-center gap-4 relative overflow-hidden">
                   <div className="relative group cursor-pointer">
                       <UiAvatar className="w-24 h-24 border-4 border-slate-50 shadow-sm">
                           <AvatarImage src="https://images.unsplash.com/photo-1612638059828-c93f8882d376?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYWxlJTIwYXNpYW4lMjBoZWFsdGhjYXJlJTIwd29ya2VyJTIwcG9ydHJhaXR8ZW58MXx8fHwxNzcwODYyNzY3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" />
                           <AvatarFallback>สส</AvatarFallback>
                       </UiAvatar>
                   ...
                   <div className="text-center">
                       <h2 className="text-xl font-bold text-slate-800">คุณสมศักดิ์ รักบริการ</h2>
                       <p className="text-slate-500 text-sm">พยาบาลวิชาชีพชำนาญการ · รพ.สต.ริมใต้</p>
                   ...
                   <div className="w-full grid grid-cols-1 gap-3 mt-2">
                        <div className="flex items-center gap-3 text-sm text-slate-600 bg-slate-50 p-3 rounded-lg border border-slate-100">
                            ...
                            <span className="truncate">somsak.r@rimtai-pcu.go.th</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm text-slate-600 bg-slate-50 p-3 rounded-lg border border-slate-100">
