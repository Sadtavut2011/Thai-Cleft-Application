...
export const PCUReferralDetail: React.FC<ReferralDetailProps> = ({
    referral,
    onBack,
    onExit,
    initialHN,
                ...
                {(referral.status === 'Accepted' || referral.status === 'accepted') && (
                    <div className="bg-green-50/50 border border-green-200 rounded-2xl p-4 shadow-sm flex flex-col justify-center animate-in fade-in slide-in-from-top-2">
                        ...
                        <div className="font-bold text-green-700 text-lg">
                            ...
                            {formatThaiFullDate(new Date(referral.appointmentDate || referral.acceptedDate || new Date()))} 
                            <span className="text-green-600/60 text-sm font-normal ml-2">
                                เวลา {formatTime(new Date(referral.appointmentDate || referral.acceptedDate || new Date()))} น.
                            </span>
                        </div>
                    </div>
                )}
