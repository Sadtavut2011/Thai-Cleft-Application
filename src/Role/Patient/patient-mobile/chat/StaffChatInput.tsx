...
export default function StaffChatInput({ inputText, setInputText, onSendMessage }: StaffChatInputProps) {
  ...
  return (
    <>
      ...
      {/* Spacer to prevent content from being hidden behind the fixed input */}
      <div className="h-[140px] shrink-0 w-full bg-transparent" />
      
      {/* Fixed Input Area - Replacing Bottom Navigation */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t z-[100] shadow-[0_-4px_20px_-4px_rgba(0,0,0,0.05)]">
         <div className="p-3 space-y-3 pb-8 md:pb-4"> {/* Added extra padding bottom for mobile home indicator */}
             <form 
