...
export function HomeVisitForm({ onBack, onSave }: HomeVisitFormProps) {
                ...
                return (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                <Label>ระย���ทางในการเดินทางมารักษา (กม.)</Label>
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                        <div className="space-y-4">
                            ...
                            {[
                                ...
                                "3. ท่านทำอะไรไม่ได้เลย เพราะ��ระสาทตึงเครียด",
    ...
    return (
        <div className="flex flex-col h-full bg-slate-50">
            <style>
            {`
                /* CSS Hack to hide the main mobile navigation bar when this component is mounted */
                .fixed.bottom-0.left-0.w-full.bg-white.z-50.rounded-t-\\[24px\\] {
