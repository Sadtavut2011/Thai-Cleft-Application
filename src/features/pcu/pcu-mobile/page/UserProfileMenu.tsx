...
export default function UserProfileMenu({ onBack }: { onBack?: () => void }) {
  return (
           ...
           <div className="max-w-md mx-auto p-4 space-y-6">
               ...
               <div className="bg-white rounded-xl p-6 shadow-sm flex flex-col items-center gap-4 relative overflow-hidden">
                   <div className="relative group cursor-pointer">
                       <UiAvatar className="w-24 h-24 border-4 border-slate-50 shadow-sm">
                           <AvatarImage src="https://images.unsplash.com/photo-1592393532405-fb1f165c4a1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmZW1hbGUlMjBhc2lhbiUyMGRvY3RvciUyMHBvcnRyYWl0fGVufDF8fHx8MTc2Nzc3OTYzMnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" />
                   ...
                   <div className="text-center">
                       <h2 className="text-xl font-bold text-slate-800">นางสาวสมใจ รักบริการ</h2>
                       <p className="text-slate-500 text-sm">พยาบาลวิชาชีพชำนาญการ (รพ.สต.)</p>
                       <div className="flex items-center justify-center gap-2 mt-2">
                            <Badge variant="secondary" className="bg-purple-50 text-[#7066a9] hover:bg-purple-100 border-purple-100">Staff ID: PCU-88492</Badge>
                       </div>
                   </div>
                   ...
                   <div className="w-full grid grid-cols-1 gap-3 mt-2">
                        <div className="flex items-center gap-3 text-sm text-slate-600 bg-slate-50 p-3 rounded-lg border border-slate-100">
                            <Mail size={16} className="text-[#7066a9]" />
                            <span className="truncate">somjai.r@pcu.go.th</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm text-slate-600 bg-slate-50 p-3 rounded-lg border border-slate-100">
                            <Phone size={16} className="text-[#7066a9]" />
               ...
               {/* 4. History */}
                <div className="space-y-3">
                   ...
                   <div className="bg-white rounded-xl overflow-hidden shadow-sm divide-y divide-slate-100">
                        <MenuItem icon={History} label="ประวัติการเข้าสู่ระบบ" value="2 นาทีที่แล้ว" />
                   </div>
               </div>
               ...
               <div className="space-y-4 pt-4">
                   ...
                   <p className="text-center text-xs text-slate-300 font-mono">
                       v1.0.2 (20250107)
                   </p>
               </div>
           </div>
