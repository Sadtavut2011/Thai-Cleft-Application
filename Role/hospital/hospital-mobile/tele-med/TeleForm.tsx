      ...
      <div className="p-4 md:p-6 max-w-2xl mx-auto w-full space-y-6 pb-24">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 space-y-4">
                 ...
                 <div className="space-y-4">
                     <div>
                         <label className="text-xs text-slate-400 block mb-1">แพทย์ผู้ให้คำปรึกษา</label>
                         <div className="font-medium text-slate-800">{data.doctor || '-'}</div>
                     </div>
                     <div>
                         <label className="text-xs text-slate-400 block mb-1">รายละเอียด</label>
