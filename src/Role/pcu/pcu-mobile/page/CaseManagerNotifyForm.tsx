...
function SectionHeader({ number, text }: { number: string, text: string }) {
  return (
    <div className="flex items-center gap-2 mb-3">
      ...
      <h3 className="font-['IBM_Plex_Sans_Thai:SemiBold',sans-serif] text-[#7066a9] text-base">{text}</h3>
    </div>
  );
}
...
function FormLabel({ text }: { text: string }) {
  return (
    <label className="block font-['IBM_Plex_Sans_Thai:Medium',sans-serif] text-[#4a5565] text-sm mb-1.5">
      {text}
    </label>
  );
}
      ...
      <div>
        ...
        <div className="space-y-4 pl-1">
          <div>
            ...
            <p className="mt-2 font-['IBM_Plex_Sans_Thai:Light',sans-serif] text-[#99a1af] text-xs leading-relaxed">
