                    ...
                    <div className="animate-in fade-in duration-300">
                        <div className="mb-6">
                            ...
                            <div className="flex justify-end">
                                <button className="bg-[#6a5acd] hover:bg-[#5a4db8] text-white text-[14px] font-['IBM_Plex_Sans_Thai'] px-3 py-1.5 rounded-[10px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] transition-all active:scale-95 flex items-center gap-2">
                                ...
                                <div key={index} className="relative pl-8 pb-8 last:pb-0">
                                    ...
                                    <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                                        ...
                                        <div className="text-xs text-slate-500 mt-2 space-y-1">
                                            ...
                                            {visit.detail && (
                                                <div className="text-slate-400 mt-2 line-clamp-2">
                                                    {visit.detail}
                                                </div>
                                            )}
                                        </div>
                        ...
                        <div className="relative pl-2 ml-2">
                            {patient.appointmentHistory?.map((appt: any, index: number) => (
                                <div key={index} className="relative pl-8 pb-8 last:pb-0">
                                        ...
                                        <div className={`p-4 rounded-xl border ${appt.status === 'upcoming' ? 'bg-blue-50 border-blue-100 shadow-sm' : 'bg-slate-50 border-slate-100'}`}>
                                        <div className="flex justify-between items-center mb-1">
                        ...
                        <div className="relative pl-2 ml-2">
                            {patient.teleConsultHistory?.map((item: any, index: number) => (
                                <div key={index} className="relative pl-8 pb-8 last:pb-0">
                                        ...
                                        <div className="flex items-center gap-2 text-xs text-slate-500 mt-2">
                                            <span className="flex items-center gap-1"><Home size={12} /> {item.from} <ChevronLeft size={10} className="rotate-180" /> {item.to}</span>
                                        </div>
                                        {item.doctor !== '-' && (
                                            <div className="text-xs text-slate-400 mt-1 flex items-center gap-1">
