    ...
    return (
        <div className="container mx-auto py-8 px-4 max-w-5xl">
            ...
            <div className="space-y-8">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Select>
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="floss">ไหมขัดฟัน</SelectItem>
                                                    <SelectItem value="mouthwash">น้ำยาบ้วนปาก</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                    </div>
                ...
                {/* Footer Buttons */}
                <div className="flex justify-end gap-4 sticky bottom-0 bg-white p-4 border-t shadow-lg rounded-t-lg z-10">
                    <Button variant="outline" size="lg">บันทึกแบบร่าง</Button>
                    <Button size="lg" className="bg-[#4C4398] hover:bg-[#3b3476]">
