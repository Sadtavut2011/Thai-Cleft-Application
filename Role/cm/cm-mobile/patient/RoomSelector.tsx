...
import { Search, Check, ChevronLeft, DoorOpen, Activity, Syringe, Scan } from "lucide-react";
...
const CATEGORIES = ["ทั้งหมด", "OPD", "IPD", "ER", "OR"];
...
const ROOM_OPTIONS: RoomOption[] = [
  ...
  // อื่นๆ (ไม่มี category ที่ match จะแสดงใน "ทั้งหมด")
      ...
      <div className="sticky top-0 z-[10000] w-full bg-[#7066a9] shadow-md flex flex-col">
        ...
        <div className="h-[64px] px-4 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-white text-lg font-bold">เลือกห้องตรวจ</h1>
            </div>
        </div>
      </div>
