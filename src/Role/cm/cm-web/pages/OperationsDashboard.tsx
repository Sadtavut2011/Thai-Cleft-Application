...
// Fallback Container component (Calendar style icon)
const Container = () => (
    <svg 
...
function StatCard({ title, value, subtitle, icon, trend, trendUp, colorClass }: StatCardProps) {
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-between h-full transition-all hover:shadow-md">
      <div className="flex justify-between items-start mb-4">
        <div className={cn("p-3 rounded-lg", colorClass.replace('text-', 'bg-'))}>
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard 
          ...
          icon={<div className="w-6 h-6"><Home className="w-full h-full" /></div>}
          colorClass="text-[#7367f0]"
        ...
        <StatCard 
          ...
          icon={<div className="w-12 h-12 -m-3"><Container /></div>}
          colorClass="text-[#00cfe8]"
        ...
        <StatCard 
          ...
          colorClass="text-[#28c76f]"
        />
        <StatCard 
          title="Tele-consult" 
          value="32" 
          subtitle="ชั่วโมงการปรึกษาเดือนนี้" 
          icon={<Video size={24} />}
          colorClass="text-[#ea5455]"
          trend="+5% usage"
          trendUp={true}
        />
        <StatCard 
