...
export function HomeVisitADD({ onBack, onSubmit, initialPatientId, initialPatient, isModal = false }: HomeVisitADDProps) {
  const [selectedPatientId, setSelectedPatientId] = useState<string>(initialPatientId || initialPatient?.id || (MOCK_PATIENTS[0]?.id || ""));
            ...
            <div className="space-y-3">
              ...
              <Popover open={open} onOpenChange={setOpen}>
                ...
                <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-0" align="start">
                  <Command>
                    <CommandInput placeholder="พิมพ์ื่อ หรือ HN..." />
                    <CommandList>
