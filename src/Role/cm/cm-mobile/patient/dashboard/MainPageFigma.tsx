...
export default function MainPageFigma() {
  return (
    <div className="bg-slate-50 relative size-full" data-name="Main page">
      <div className="absolute h-[220px] left-0 top-0 w-[375px]">
        <div className="absolute bg-[#49358e] h-[220px] left-0 rounded-[0px_0px_24px_24px] top-0 w-[375px]" />
        <Frame12 />
      </div>
      <div className="absolute contents left-[12px] top-[164px]">
        <div className="absolute flex flex-col gap-[10px] items-start left-[12px] top-[164px] w-[351px]">
          <Frame107 />
          <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full">
            <Frame33 />
            <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-[18px] shadow-[0px_4px_10px_0px_rgba(0,0,0,0.13)] shrink-0">
              <div className="overflow-clip rounded-[inherit] size-full">
                <div className="box-border content-stretch flex flex-col gap-[4px] items-start px-[12px] py-[8px] relative w-full">
                  <p className="font-['IBM_Plex_Sans_Thai:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#3c3c3c] text-[16px] text-nowrap whitespace-pre">งานของฉัน</p>
                  <Frame37 />
                  <Group3 />
                  <Group5 />
                  <Group7 />
      ...
      <div className="absolute contents left-[12px] top-[464px]">
        <div className="absolute h-[157px] left-[12px] top-[464px] w-[351px]">
          <div className="absolute bg-white h-[157px] left-0 rounded-[16px] shadow-[0px_4px_10px_0px_rgba(0,0,0,0.13)] top-0 w-[351px]" />
          <div className="absolute h-[157px] left-0 overflow-hidden top-0 w-[351px]">
            <img alt="" className="absolute h-[157px] left-0 max-w-none object-cover top-0 w-[351px]" src={imgFrame36} />
          </div>
        </div>
      </div>
    </div>
