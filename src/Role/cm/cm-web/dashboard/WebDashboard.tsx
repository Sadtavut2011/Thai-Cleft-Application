...
import CMSidebar from '../layout/CMSidebar';
...
import PatientManagement from '../patient/treatment-plan';
import { NewPatient } from '../pages/NewPatient';
import { CaseManagerNotifyForm } from '../pages/CaseManagerNotifyForm';
import { PatientDetailView as PatientDetail } from '../patient/PatientDetailView';
...
import { TreatmentPlanSystem } from '../pages/TreatmentPlanSystem';
import { OperationsDashboard } from '../pages/OperationsDashboard';
import FundSystem from '../operations/fund-request/FundSystem';
import GISSystem from '../patient/gis-map/gis-patient';
...
export default function WebDashboard() {
  ...
  const renderContent = () => {
    switch (activePage) {
      case "ระบบนัดหมาย":
        return <AppointmentSystem onNavigateToSystem={(sys: string) => setActivePage(sys)} />;
