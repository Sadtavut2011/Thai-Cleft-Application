...
export function HomeVisitDetail({ request, onBack, onCancelRequest, onOpenForm, showFooter = false, onViewHistory, onContactPCU }: HomeVisitDetailProps) {
  return createPortal(
    <div className="fixed inset-0 z-[9999] bg-[#f8f9fa] w-full h-[100dvh] overflow-y-auto font-sans [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      {/* Fixed Footer with Actions (Only when shown from AppointmentSystem) */}
      {showFooter && (
