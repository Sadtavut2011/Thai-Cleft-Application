// ===== Shared types & helpers for CaseManager mobile drill-downs =====
import { CASE_MANAGER_DATA } from '../../../../../data/patientData';
export { CASE_MANAGER_DATA };
export type { CaseManager } from '../../../../../data/patientData';
