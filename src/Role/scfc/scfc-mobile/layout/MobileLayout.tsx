                        ...
                        >
                            {selectedHistoryPatient ? (
                                <PatientDetailView
                                    ...
                                    onEdit={(id: string) => {
                                        // For now, handle edit by setting editing patient
                                        // You might need to find the patient object by ID if strictly following the signature
                                        // But here we just open the modal.
                                        const p = patients.find((pat: any) => String(pat.id) === String(id));
                                        if (p) {
                                            setEditingPatient(p);
                                ...
                                <PatientDirectory
                                    patients={patients}
                                    onSelectPatient={(patient) => setSelectedHistoryPatient(patient)}
                                    onAddPatient={() => {
                                        setCurrentView('registration');
                                        setRegistrationStep(1);
                                    }}
