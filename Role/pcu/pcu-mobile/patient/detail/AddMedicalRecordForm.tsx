...
import { TreatmentSelector } from '../../../../cm/cm-mobile/patient/TreatmentSelector';
import { HospitalSelector } from '../../../../cm/cm-mobile/patient/hospitalSelector';
import { RoomSelector } from '../../../../cm/cm-mobile/patient/RoomSelector';
import { MedicSelector } from '../../../../cm/cm-mobile/patient/medicSelector';
                ...
                {step === 1 && (
                    <div className="space-y-4 animate-in slide-in-from-right-4 duration-300">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div onClick={() => setShowHospitalSelector(true)}>
                                <Input 
                                    value={formData.hospital}
                                    readOnly
                                    placeholder="ระบุโรงพยาบาล"
                                    className="h-[48px] rounded-xl border-slate-200 text-sm focus-visible:ring-[#7066a9] pointer-events-none"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div onClick={() => setShowRoomSelector(true)}>
                                <Input 
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div onClick={() => setShowMedicSelector(true)}>
                                <Input 
