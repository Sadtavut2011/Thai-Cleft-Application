import svgPaths from "../../../imports/svg-pwd8faldus";
...
function Frame() {
  return (
    <div className="absolute box-border content-stretch flex items-center justify-between left-0 px-[16px] py-[12px] top-[60px] w-[402px]">
