...
const HomeVisitRequestCard = () => (
     <div className="bg-orange-50 p-4 rounded-2xl flex items-center justify-between cursor-pointer hover:bg-orange-100 transition-colors">
        <div className="flex flex-col gap-1">
            <span className="font-bold text-gray-800">คำร้องขอเยี่ยมบ้านใหม่</span>
            <div className="flex items-center gap-2 text-sm text-gray-600">
                <User size={14} className="text-orange-500" />
                <span>นาย สมควร ควรหา (HN: 66088888)</span>
            </div>
        </div>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div>
           <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-gray-500">พฤหัสบดีที่ 25 ธ.ค. 2568</span>
           </div>
           <div className="space-y-3">
              {/* New Request Card */}
              <HomeVisitRequestCard />
              ...
              <div className="bg-blue-50 p-4 rounded-2xl flex items-center justify-between cursor-pointer hover:bg-blue-100 transition-colors">
                  <div className="flex flex-col gap-1">
                      <span className="font-bold text-gray-800">นัดหมายผู้ป่วย (10:30 น.)</span>
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                          <User size={14} className="text-blue-500" />
                          <span>คุณสมชาย ใจดี (HN: 66091234)</span>
                      </div>
                  </div>
              ...
              <div className="bg-green-50 p-4 rounded-2xl flex items-center justify-between cursor-pointer hover:bg-green-100 transition-colors">
                  <div className="flex flex-col gap-1">
                      <span className="font-bold text-gray-800">Tele-consultation (11:00 น.)</span>
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                          <User size={14} className="text-green-500" />
                          <span>คุณสมปอง รักรักษา (HN: 66099999)</span>
                      </div>
                  </div>
           ...
           <div className="mt-8 pt-6 border-t border-gray-100">
               <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-bold text-gray-800 opacity-80">
                      วันพรุ่งนี้
                  </h2>
                  <span className="text-sm text-gray-500">ศุกร์ที่ 26 ธ.ค. 2568</span>
               </div>
               <div className="space-y-3 opacity-90">
                  <div className="bg-blue-50 p-4 rounded-2xl flex items-center justify-between cursor-pointer hover:bg-blue-100 transition-colors">
                      <div className="flex flex-col gap-1">
                          ...
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                              <User size={14} className="text-blue-500" />
                              <span>คุณวิชัย ใจดี (HN: 66011223)</span>
                          </div>
                      </div>
                      <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center text-white shadow-sm">
                          <ChevronRight size={18} />
...
export default function PCUWorkSystems({ 
  ...
  const mockPatients = [
      { id: 1, name: 'ด.ช. รักดี มีสุข', hn: '66012345', age: '5 ปี', img: 'https://images.unsplash.com/photo-1571270237703-6ac8a769ad7a?w=150&h=150&fit=crop' },
      { id: 2, name: 'น.ส. ใจใส มั่นคง', hn: '66088990', age: '16 ปี', img: 'https://images.unsplash.com/photo-1650602979536-74222284e5e2?w=150&h=150&fit=crop' },
      { id: 3, name: 'ด.ญ. พอใจ ยิ้มสวย', hn: '65112233', age: '2 ปี', img: 'https://images.unsplash.com/photo-1588410670460-cdab54625253?w=150&h=150&fit=crop' },
      { id: 4, name: 'นาย สมชาย แข็งแรง', hn: '65778811', age: '25 ปี', img: 'https://images.unsplash.com/photo-1633177188754-980c2a6b6266?w=150&h=150&fit=crop' },
  ];
  ...
  return (
    <div className="h-full flex flex-col bg-slate-50 relative overflow-hidden">
        ...
        <div className="relative flex-1 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
            ...
            {currentSystem === 'visit' && (
                <HomeVisitSystem onBack={() => setCurrentSystem('dashboard')} initialViewMode="list" />
            )}
                        ...
                        <div className="space-y-2 relative">
                            ...
                            <div className="relative z-20">
                                ...
                                <input 
                                    ...
                                    placeholder="พิมพ์ชื่อ หรือ HN เพื่อค้น��า..."
                                    value={searchTerm}
