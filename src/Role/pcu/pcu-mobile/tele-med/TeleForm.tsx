...
export function TeleForm({ data, onBack }: TeleFormProps) {
  ...
  return (
    <div className="bg-slate-50 min-h-screen flex flex-col font-['IBM_Plex_Sans_Thai'] animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      <div className="p-4 md:p-6 max-w-2xl mx-auto w-full space-y-6 pb-20">
            {/* Status Card */}
            ...
            <Button 
                onClick={onBack}
                className="w-full h-12 rounded-xl text-base bg-white text-slate-700 border border-slate-200 hover:bg-slate-50 shadow-sm mt-4"
            >
                ย้อนกลับ
            </Button>
      </div>
