                    ...
                    {step === 2 && (
                        <div className="space-y-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={destinationHospital} onValueChange={setDestinationHospital}>
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="โรงพยาบาลศรีนครินทร์">โรงพยาบาลศรีนครินทร์</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div
                                    ...
                                    className="border-2 border-dashed border-slate-200 rounded-2xl p-8 flex flex-col items-center justify-center text-center bg-white hover:bg-slate-50 transition-colors cursor-pointer"
                                >
                                    <input
                                        type="file"
                                        ref={fileInputRef}
                                    ...
                                    <div className="space-y-2">
                                        {files.map((file, index) => (
                                            <div key={index} className="flex items-center justify-between p-3 bg-white border border-slate-100 rounded-xl shadow-sm">
                                                ...
                                                <button onClick={() => removeFile(index)} className="text-slate-400 hover:text-slate-600 p-1">
                                                    <X className="w-5 h-5" />
                                                </button>
                                            </div>
                                        ))}
                        ...
                        <div className="space-y-8 pt-4">
                            ...
                            <div className="bg-white rounded-2xl p-6 space-y-4 border border-slate-100 shadow-sm">
                                ...
                                <div className="flex justify-between items-baseline">
                                    ...
                                    <span className="text-slate-800 font-bold">{destinationHospital || "-"}</span>
                                </div>
                                <div className="flex justify-between items-baseline">
                                    <span className="text-slate-500">เอกสารแนบ:</span>
                                    <span className="text-slate-800 font-bold">{files.length} รายการ</span>
                                </div>
                            </div>
