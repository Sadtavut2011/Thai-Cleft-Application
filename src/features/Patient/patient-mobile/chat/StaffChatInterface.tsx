    ...
    <div className={cn(
        ...
        {chat ? (
          <>
            ...
            <header className="h-[64px] md:h-[72px] border-b flex items-center justify-between px-4 md:px-6 bg-white shrink-0 shadow-sm z-10">
              <div className="flex items-center gap-3 md:gap-4 overflow-hidden">
                ...
                <div className="min-w-0">
                  <h3 className="font-bold text-gray-900 flex items-center gap-2 truncate text-sm md:text-base">
                    {chat.name}
                    {chat.type === 'group' && (
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-500 truncate">
                    <span className="font-medium text-[#49358E] truncate">ผู้ป่วย: {chat.patientName}</span>
                    {chat.status === 'online' && (
            ...
            {/* Messages Area */}
            <div className="flex-1 bg-[#F8F9FA] p-4 md:p-6 overflow-y-auto flex flex-col gap-4">
