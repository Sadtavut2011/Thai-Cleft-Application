...
import StaffChatList from '../../../../Role/cm/cm-mobile/chat/StaffChatList';
...
import CMAppointmentSystem from '../../../../Role/cm/cm-mobile/appointment/AppointmentSystem';
...
import { NewPatientDetail } from '../../../../Role/cm/cm-mobile/page/NewPatientDetail';
        ...
        <div className={`transition-all duration-500 ease-in-out flex flex-col h-full w-full overflow-y-auto pb-20`}>
            ...
            {currentView === 'dashboard' && (
                <StandardPageLayout title="ภาพรวม" bypassContentCard={true}>
                    <MobileDashboard 
                        ...
                        onNavigateSystem={(system: string) => {
            ...
            {currentView === 'calendar' && (
                <StandardPageLayout title="ปฏิทิน" bypassContentCard={true}>
                    <CMAppointmentSystem 
                         patients={patients}
                         onNavigateToSystem={(system: string, data: any) => {
                             if (system === 'patient-detail') {
                                 setSelectedHistoryPatient(data);
                                 setCurrentView('patients');
                             } else {
                                 handleNavigateToSystem(system, data);
                             }
                         }}
                    />
                </StandardPageLayout>
            ...
            {/* Feature: SCFC Appointment Dashboard (from Quick Menu) */}
            {currentView === 'appointment-dashboard' && (
                <StandardPageLayout title="" bypassContentCard={true}>
