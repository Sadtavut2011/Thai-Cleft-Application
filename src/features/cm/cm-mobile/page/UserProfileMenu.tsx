           ...
           <div className="max-w-md mx-auto p-4 space-y-6">
               ...
               <div className="bg-white rounded-xl p-6 shadow-sm flex flex-col items-center gap-4 relative overflow-hidden">
                   ...
                   <div className="text-center">
                       <h2 className="text-xl font-bold text-slate-800">พญ. ปนัดดา รักษาดี</h2>
                       <p className="text-slate-500 text-sm">แพทย์เวชปฏิบัติทั่วไป</p>
                       <div className="flex items-center justify-center gap-2 mt-2">
                            <Badge variant="secondary" className="bg-purple-50 text-[#7066a9] hover:bg-purple-100 border-purple-100">Staff ID: 88492</Badge>
                       </div>
                   </div>
                   ...
                   <div className="w-full grid grid-cols-1 gap-3 mt-2">
                        <div className="flex items-center gap-3 text-sm text-slate-600 bg-slate-50 p-3 rounded-lg border border-slate-100">
                            ...
                            <span className="truncate">panadda.doc@hospital.com</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm text-slate-600 bg-slate-50 p-3 rounded-lg border border-slate-100">
