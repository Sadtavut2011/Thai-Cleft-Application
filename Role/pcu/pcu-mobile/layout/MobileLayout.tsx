...
import AppointmentSystem from '../../../../Role/cm/cm-mobile/appointment/AppointmentSystem';
...
import { HomeVisitForm } from '../../../../Role/cm/cm-mobile/home-visit/forms/HomeVisitForm';
                        ...
                        onSave={(data) => {
                             ...
                             if (selectedHomeVisit) {
                                 ...
                                 if (visitIndex !== -1) {
                                     ...
                                     // Optional: Update results/notes if passed in 'data'
                                 }

                                 // Force re-render of AppointmentSystem by refreshing patients reference
