        ...
        <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-100 rounded-[16px] p-6 shadow-sm relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div className="space-y-2">
                        <label className="text-[16px] font-bold text-[#120d26]">เลขประจำตัวประชาชน</label>
                         <div className="relative">
                            <Input 
                                className="h-[50px] rounded-[12px] bg-[#F5F6FA] border-none text-[#120d26] placeholder:text-gray-400 pl-12"
                    ...
                    <div className="space-y-2">
                        <label className="text-[16px] font-bold text-[#120d26]">ความสัมพันธ์</label>
                         <div className="relative">
                            <Select>
                                <SelectTrigger className="h-[50px] rounded-[12px] bg-[#F5F6FA] border-none text-gray-500 pl-12">
                    ...
                    <div className="space-y-2">
                        <label className="text-[16px] font-bold text-[#120d26]">วัน/เดือน/ปีเกิด</label>
                        <div className="relative">
                             <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">
                                <MessageSquare className="w-5 h-5 fill-gray-500 text-gray-500" />
                            </div>
                            <Input 
                                className="h-[50px] rounded-[12px] bg-[#F5F6FA] border-none text-[#120d26] placeholder:text-gray-400 pl-12 pr-10"
                                type="date"
                                value={birthDate}
                                onChange={(e) => setBirthDate(e.target.value)}
                            />
                            <Calendar className="absolute right-4 top-1/2 -translate-y-1/2 text-[#4C4398] w-5 h-5 pointer-events-none" />
                        </div>
                    </div>
                    <div className="space-y-2">
                        <label className="text-[16px] font-bold text-[#120d26]">อายุ</label>
                         <div className="relative">
                            <div className="h-[50px] rounded-[12px] bg-[#F5F6FA] flex items-center pl-12 text-[rgb(101,102,108)] font-medium">
                                {age ? `${age} ปี` : "คำนวณอายุอัตโนมัติ"}
                            </div>
                             <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">
                                <MessageSquare className="w-5 h-5 fill-gray-500 text-gray-500" />
                            </div>
                    ...
                    <div className="space-y-2">
                        <label className="text-[16px] font-bold text-[#120d26]">อาชีพ</label>
                         <div className="relative">
                            <Select>
                                <SelectTrigger className="h-[50px] rounded-[12px] bg-[#F5F6FA] border-none text-gray-500 pl-12">
                                    <SelectValue placeholder="เลือกอาชีพ" />
                     ...
                     <div className="space-y-2 md:col-span-2">
                        <label className="text-[16px] font-bold text-[#120d26]">สถานะ</label>
                         <div className="relative">
                            <Select>
                                <SelectTrigger className="h-[50px] rounded-[12px] bg-[#F5F6FA] border-none text-gray-500 pl-12">
...
function Step6HospitalInfo({ onNext, isLastStep }: { onNext: () => void; isLastStep?: boolean }) {
    return (
        <div className="space-y-6">
             <Button className="w-full h-[50px] rounded-[12px] bg-[#4C4398] hover:bg-[#3f377f] text-white text-[16px] font-medium flex items-center justify-center gap-2">
                <Plus className="w-5 h-5" /> เพิ่มโรงพยาบาล
            </Button>
            ...
            <div className="bg-white border border-gray-100 rounded-[16px] p-6 shadow-sm relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                     <div className="space-y-2">
                        <label className="text-[16px] font-bold text-[#120d26]">โรงพยาบาล *</label>
                         <div className="relative">
                            <Select>
                                <SelectTrigger className="h-[50px] rounded-[12px] bg-[#F5F6FA] border-none text-gray-500 pl-12">
                     ...
                     <div className="space-y-2 flex items-end">
                        <div className="w-full h-[50px] rounded-[12px] border border-gray-200 bg-white flex items-center justify-between px-4">
                            <span className="text-[16px] font-medium text-[#120d26]">โรงพยาบาลต้นสังกัด</span>
                            <div className="w-6 h-6 rounded-full border-2 border-[#4C4398] flex items-center justify-center">
                                <div className="w-3 h-3 bg-[#4C4398] rounded-full" />
                            </div>
                        </div>
                    </div>

                    <div className="space-y-2">
                        <label className="text-[16px] font-bold text-[#120d26]">HN</label>
                         <div className="relative">
                            <Input 
                                className="h-[50px] rounded-[12px] bg-[#F5F6FA] border-none text-[#120d26] placeholder:text-gray-400 pl-12"
                                placeholder="ระบุ HN"
                    ...
                    <div className="space-y-2">
                        <label className="text-[16px] font-bold text-[#120d26]">เข้ารับการรักษาครั้งแรกเมื่อไหร่</label>
                         <div className="relative">
                             <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">
                                <MessageSquare className="w-5 h-5 fill-gray-500 text-gray-500" />
                            </div>
                    ...
                    <div className="space-y-2">
                        <label className="text-[16px] font-bold text-[#120d26]">ระยะทางที่เดินทางมารักษา</label>
                         <div className="relative">
                            <Input 
                                className="h-[50px] rounded-[12px] bg-[#F5F6FA] border-none text-[#120d26] placeholder:text-gray-400 pl-12"
                     ...
                     <div className="space-y-2">
                        <label className="text-[16px] font-bold text-[#120d26]">ระยะเวลาที่เดินทางมารักษา</label>
                         <div className="relative">
                            <Input 
                                className="h-[50px] rounded-[12px] bg-[#F5F6FA] border-none text-[#120d26] placeholder:text-gray-400 pl-12"
