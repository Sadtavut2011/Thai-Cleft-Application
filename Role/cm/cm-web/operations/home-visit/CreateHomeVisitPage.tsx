...
import { ArrowLeft, Home, Calendar, Clock, MapPin, User, Navigation, Search as SearchIcon, ClipboardList, ChevronRight, Check, X as XIcon } from "lucide-react";
import { toast } from "sonner";
import { cn } from "../../../../../components/ui/utils";
import { VisitSelectorWeb } from './VisitSelectorWeb';
import { PATIENTS_DATA } from '../../../../../data/patientData';
import { PCU_OPTIONS } from '../../../../cm/cm-mobile/patient/pcuSelector';
...
const MOCK_RPH = PCU_OPTIONS.map(pcu => pcu.label);
...
export function CreateHomeVisitPage({ onBack, onSubmit, initialData }: CreateHomeVisitPageProps) {
  ...
  // If showing visit selector, render it as a full page
        ...
        <div className="bg-white rounded-lg shadow-sm border border-[#EBE9F1] p-6 max-w-4xl mx-auto">
             ...
             <div className="space-y-8">
                 ...
                 <div className="space-y-4">
                        ...
                        {/* Step 2.5: Visit Form Selector */}
                        <div className="space-y-4">
                            <h3 className="font-semibold text-base text-[#5e5873] flex items-center gap-2 border-b border-gray-100 pb-2">
                                <ClipboardList className="w-5 h-5 text-[#7367f0]" /> ฟอร์มเยี่ยมบ้าน
                            </h3>
                            <div 
                            ...
                            >
                                <div className={cn(
                                    ...
                                    <div className="flex items-center gap-3 flex-1 min-w-0">
                                        <ClipboardList size={16} className={selectedVisitForm ? "text-[#7367f0]" : "text-gray-400"} />
                                        <span className={cn(
                                            "text-sm truncate",
                                            selectedVisitForm ? "text-[#5e5873] font-medium" : "text-gray-400"
                                        )}>
