  ...
  return (
    <div className="bg-[#F4F0FF]/40 min-h-screen flex flex-col font-sans pb-20">
      ...
      <div className="sticky top-0 w-full bg-[#7066a9] h-[64px] px-4 flex items-center gap-3 shrink-0 z-50 shadow-md">
          ...
          <h1 className="text-white text-lg font-bold">Tele-med</h1>
      </div>
                    ...
                    <PopoverContent align="end" className="w-[240px] p-2 rounded-xl bg-white shadow-xl border border-[#E3E0F0] max-h-[300px] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
                         <div className="flex flex-col">
                             <button
                                  ...
                                  className={cn(
                                      "w-full text-left px-3 py-3 text-[14px] font-medium transition-colors rounded-lg",
                                      selectedHospital === 'ทุกหน่วยงาน' ? "bg-[#F4F0FF] text-[#49358E]" : "text-slate-700 hover:bg-[#F4F0FF]/50"
                                  )}
                              >
                                  ทุกหน่วยงาน
                              </button>
         ...
         <div className="grid grid-cols-2 gap-3">
              <div className="bg-white p-3 rounded-xl border border-[#E3E0F0] shadow-sm">
                 <div className="flex justify-between items-start mb-2">
                     ...
                     <Badge className="bg-[#F4F0FF] text-[#49358E] border-none text-[9px] font-bold">LIVE</Badge>
                 </div>
                 <span className="text-xl font-black text-[#37286A] leading-none">{stats.active}</span>
                 <p className="text-[9px] font-bold text-[#7066A9] mt-1 uppercase">กำลังปรึกษา</p>
             </div>
             ...
             <div className="bg-white p-3 rounded-xl border border-[#D2CEE7] shadow-sm">
                 ...
                 <span className="text-xl font-black text-[#37286A] leading-none">{stats.avgWait}</span>
                 <p className="text-[9px] font-bold text-[#7066A9] mt-1 uppercase">รอเฉลี่ย</p>
             </div>
             ...
             <div className="bg-white p-3 rounded-xl border border-[#E3E0F0] shadow-sm">
                 ...
                 <span className="text-xl font-black text-[#37286A] leading-none">{stats.stability}%</span>
                 <p className="text-[9px] font-bold text-[#7066A9] mt-1 uppercase">ความเสถียร</p>
             </div>
             ...
             <div className="bg-white p-3 rounded-xl border border-[#D2CEE7] shadow-sm">
                 ...
                 <span className="text-xl font-black text-[#37286A] leading-none">{stats.specialists}</span>
                 <p className="text-[9px] font-bold text-[#7066A9] mt-1 uppercase">แพทย์พร้อม</p>
             </div>
         </div>
         ...
         <Card className="border-[#E3E0F0] shadow-sm bg-white rounded-xl overflow-hidden">
            <div className="p-4 border-b border-[#F4F0FF] flex items-center justify-between">
                <h3 className="font-bold text-[#37286A] text-xs flex items-center gap-2 uppercase tracking-wider">
                    <Signal className="text-[#7066A9]" size={14} /> System Stability
                </h3>
                <Badge className="bg-[#F4F0FF] text-[#49358E] border-none text-[9px]">Stable</Badge>
            </div>
            <div className="p-4">
                     ...
                     {isMounted ? (
                        <ResponsiveContainer width="100%" height="100%">
                            ...
                            <defs>
                                ...
                                <stop offset="5%" stopColor="#49358E" stopOpacity={0.25}/>
                                <stop offset="95%" stopColor="#49358E" stopOpacity={0}/>
                                </linearGradient>
                            </defs>
                            <Tooltip 
                            ...
                            />
                            <Area type="monotone" dataKey="stability" stroke="#49358E" fill="url(#colorStability)" strokeWidth={2} />
                            </AreaChart>
                        </ResponsiveContainer>
                     ) : (
