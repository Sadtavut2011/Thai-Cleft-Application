...
}: React.PropsWithChildren<LabelTextProps>) {
  return (
    <div
      style={{ fontVariationSettings: "'wdth' 100" }}
      className={clsx(
        "absolute flex flex-col font-medium justify-center leading-[0] text-[16px] text-black text-nowrap translate-y-[-50%]",
        additionalClassNames,
      )}
    >
...
function IconBox({
  children,
  additionalClassNames = "",
}: React.PropsWithChildren<IconBoxProps>) {
  return (
...
export default function NationalIdCardStep() {
  return (
    <div
      ...
      data-name="เลขประจำตัวประชาชน - 4"
    >
      <div
        className="absolute contents left-0 top-[2px]"
        data-name="Mask"
      >
        <div className="absolute flex h-[362px] items-center justify-center left-[309px] top-[497px] w-[393px]">
          <div className="flex-none rotate-[180deg] scale-y-[-100%]">
            <div
              className="h-[362px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-309px_-495px] mask-size-[375px_812px] opacity-50 relative w-[393px]"
              style={{ maskImage: `url('${imgEllipse70}')` }}
            >
        ...
        <div
          className="absolute h-[173.943px] left-[-107px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[107px_-744px] mask-size-[375px_812px] opacity-40 top-[746px] w-[189px]"
          style={{ maskImage: `url('${imgEllipse70}')` }}
        >
        ...
        <div
          className="absolute h-[173.943px] left-[-54px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[54px_0px] mask-size-[375px_812px] opacity-50 top-[2px] w-[189px]"
          style={{ maskImage: `url('${imgEllipse70}')` }}
        >
          <div className="absolute inset-[-57.49%_-52.91%]">
            <img
        ...
        <div
          className="absolute h-[209px] left-[198px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-198px_75px] mask-size-[375px_812px] opacity-70 top-[-73px] w-[227px]"
          style={{ maskImage: `url('${imgEllipse70}')` }}
        >
      ...
      <div className="absolute contents inset-[0.25%_-0.13%_72.66%_0]">
        <div className="absolute flex inset-[13.79%_91.3%_86.04%_8.7%] items-center justify-center">
          <div className="flex-none h-[1.391px] scale-y-[-100%] w-[0.01px]">
            <IconWrapper>
              <path
                d={svgPaths.p25b8d180}
                fill="var(--fill-0, #5A61FF)"
                id="path534"
              />
            </IconWrapper>
          </div>
        ...
        <div
          className="absolute flex flex-col font-['Noto_Sans_Thai:Medium','Noto_Sans:Medium',sans-serif] font-medium inset-[5.91%_56.27%_89.66%_8%] justify-center leading-[0] text-[#120d26] text-[24px] text-nowrap"
          style={{ fontVariationSettings: "'wdth' 100" }}
        >
        ...
        <div className="absolute contents inset-[0.25%_-0.13%_72.66%_0]">
          <div
            className="absolute inset-[0.25%_-0.13%_72.66%_0.13%]"
            data-name="Rectangle"
          >
            <div className="absolute inset-[-9.09%_-8%_-18.18%_-8%]">
              ...
              >
                <g
                  filter="url(#filter0_d_161_2147)"
                  id="Rectangle"
                >
                  <path
                    clipRule="evenodd"
                    d="M30 20H405V240H30V20Z"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feColorMatrix
                      type="matrix"
                      values="0 0 0 0 0.378817 0 0 0 0 0.451896 0 0 0 0 0.996094 0 0 0 0.08 0"
                    />
                    <feBlend
                      in2="BackgroundImageFix"
                      mode="normal"
                      result="effect1_dropShadow_161_2147"
                    />
                    <feBlend
                      in="SourceGraphic"
                      in2="effect1_dropShadow_161_2147"
                      mode="normal"
                      result="shape"
                    />
                  </filter>
          ...
          <div className="absolute contents inset-[18.04%_0_74.88%_0]">
            <div
              className="absolute inset-[19.7%_0_74.88%_0]"
              data-name="Page Controls"
            >
              <div
                className="absolute inset-[40.91%_29.73%]"
            ...
            <div
              className="absolute flex flex-col font-['Noto_Sans_Thai:SemiBold',sans-serif] font-semibold inset-[18.04%_36.67%_79%_36.93%] justify-center leading-[0] text-[#5669ff] text-[16px] text-center text-nowrap tracking-[1px] uppercase"
              style={{ fontVariationSettings: "'wdth' 100" }}
            >
      ...
      <div className="absolute contents left-[24px] top-[312.85px]">
        <div className="absolute contents left-[24px] top-[312.85px]">
          <div
            className="absolute h-[56px] left-[24px] top-[312.85px] w-[329px]"
            data-name="Textbox"
          >
            <div className="absolute contents inset-0">
              ...
              <div className="absolute contents inset-[37.04%_14.79%_38.74%_16.09%]">
                <div
                  className="absolute flex flex-col font-['Noto_Sans_Thai:Regular','Noto_Sans:Regular',sans-serif] font-normal inset-[37.04%_14.79%_38.74%_16.09%] justify-center leading-[0] text-[#747688] text-[14px]"
                  style={{
          ...
          <div
            className="absolute contents left-[39.62px] top-[326.2px]"
            data-name="Calendar"
          >
            <IconBox additionalClassNames="left-[39.62px] size-[24px] top-[326.2px]">
              <g id="comment_duotone">
                <path
                  d={svgPaths.p28f06400}
                  fill="var(--fill-0, #5669FF)"
                  fillOpacity="0.75"
                  id="Union"
                />
                <path
      ...
      <div className="absolute contents left-[111px] top-[404.85px]">
        <div
          className="absolute h-[50px] left-[111px] top-[404.85px] w-[154px]"
          data-name="Follow Button"
        >
          <div
            className="absolute bg-[#5669ff] inset-0 rounded-[10px]"
            data-name="Rectangle"
          >
            <div
              aria-hidden="true"
              className="absolute border-[#5669ff] border-[1.5px] border-solid inset-[-0.75px] pointer-events-none rounded-[10.75px]"
            />
          </div>
          <div className="absolute contents inset-[26%_18.18%_24%_40.26%]">
            <div
              className="absolute flex flex-col font-['Noto_Sans_Thai:Medium',sans-serif] font-medium inset-[26%_18.18%_24%_40.26%] justify-center leading-[0] text-[16px] text-center text-nowrap text-white"
              style={{ fontVariationSettings: "'wdth' 100" }}
            >
      ...
      <div className="absolute contents left-[24px] top-[237px]">
        ...
        <div
          className="absolute left-[44px] size-[28px] top-[253px]"
          data-name="apple 1"
        />
        ...
        <div
          className="absolute left-[44.01px] overflow-clip size-[28px] top-[252.57px]"
          data-name="apple 2"
        >
          <img
            alt=""
      ...
      <div className="absolute contents left-[24px] top-[493px]">
        <div className="absolute contents left-[24px] top-[493px]">
          <div
            className="absolute flex flex-col font-['Noto_Sans_Thai:Medium',sans-serif] font-medium justify-center leading-[0] left-[95px] text-[#120d26] text-[16px] text-nowrap top-[523px] translate-y-[-50%]"
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
          ...
          <div
            className="absolute left-[44px] overflow-clip size-[28px] top-[509px]"
            data-name="apple 1"
          >
            <img
              alt=""
      ...
      <div className="absolute contents left-[23.5px] top-[568.11px]">
        <div className="absolute contents left-[23.5px] top-[568.11px]">
          ...
          <div
            className="absolute bg-white left-[43.5px] size-[28px] top-[584.11px]"
            data-name="apple 1"
          />
