                ...
                >
                  ...
                  <td className="p-2 align-middle text-center md:text-right">
                    {(() => {
                      ...
                      if (scope === 'appointment') {
                        if (['waiting', 'waiting-doctor', 'pending', 'waiting_staff'].includes(status)) { colorClass = 'bg-orange-100 text-orange-700'; label = 'รอพบแพทย์'; }
                        else if (status === 'checked-in') { colorClass = 'bg-emerald-100 text-emerald-700'; label = 'มาแล้ว'; }
