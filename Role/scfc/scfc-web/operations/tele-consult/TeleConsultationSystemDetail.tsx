...
// Helper: format date to Thai short date
                            ...
                            <div>
                                ...
                                <div className="mt-2 flex flex-col gap-1">
                                    <div className="flex items-center gap-2 text-gray-700 font-medium">
                                        ...
                                        {formatThaiShortDate(selectedAppointment.date)}
                                    </div>
                                    <div className="flex items-center gap-2 text-gray-700 font-medium">
                        ...
                        <div>
                            ...
                            <div className="p-3 bg-slate-50 rounded-lg border border-slate-200 group relative">
                                ...
                                <Button 
                                    ...
                                    onClick={() => {navigator.clipboard.writeText(selectedAppointment.meetingLink); toast.success("คัดลอกลิงค์แล้ว")}}
                                >
                                    <Copy className="w-3.5 h-3.5"/>
                                </Button>
                            </div>
                            <p className="text-[10px] text-gray-400 mt-2 text-center">
                                ลิงค์จะหมดอายุภายใน 24 ชม. หลังจบการนัดหมาย
                            </p>
                        </div>
